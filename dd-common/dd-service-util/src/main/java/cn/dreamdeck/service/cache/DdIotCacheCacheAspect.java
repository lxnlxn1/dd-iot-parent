package cn.dreamdeck.service.cache;
...
@Component
@Aspect
public class DdIotCacheCacheAspect {
    ...
    @Around("@annotation(cn.dreamdeck.service.cache.DdIotCache)")
    public Object cacheAroundAdvice(ProceedingJoinPoint point){
        ...
        // 得到注解
        DdIotCache gmallCache = signature.getMethod().getAnnotation(DdIotCache.class);
