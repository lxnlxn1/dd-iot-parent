//package cn.dreamdeck.common.minio.http;
//
//
//
...
//import cn.dreamdeck.common.minio.service.MinioTemplate;
//import cn.dreamdeck.common.minio.vo.MinioItem;
//import cn.dreamdeck.common.minio.vo.MinioObject;
...
//	private List<MinioItem> allObjectsByPrefix;
//
//	/**
//	 * Bucket Endpoints
//	 */
...
//
//
////		List<MinioItem> minioItemList = (List<MinioItem>) template.getAllObjectsByPrefix(bucketName, objectName, true);
